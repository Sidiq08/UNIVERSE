  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 mb-0">
        <a href="<?= base_url(); ?>/Home" class="text-success">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Men</strong></div>
    </div>
  </div>
</div>
</div>
    ...
    <div class="container-fluid">
      <div class="card-deck mt-3">
        <div class="card" style="width: 50rem;">
          <img src="<?= base_url(); ?>assets/img/men4.jpg" class="card-img-top" alt="...">
        </div>
      </div>
  </section>
